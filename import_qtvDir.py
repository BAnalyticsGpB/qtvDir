    ...
    for dirname in dirnames:
        ...
        if str(date[0]) != str(today):
            ...
            try:
                    ...
                    for filename in filenames2:
                        if os.path.splitext(filename)[1] == ".xml":
                            ...
                            for stations in station_mesure:
                                ...
                                # print(number_speed)
                                speed_rate = stations.getElementsByTagName('speed')[0].childNodes[0].nodeValue
                                # print(speed_rate)

                                data_list.append([id, pub_time, time_default, number_flow, flow_rate, number_speed, speed_rate])
                ...
                print("probleme de inserer " + path)
